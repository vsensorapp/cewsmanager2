...
const workspace = {
  ...
  name: "workspace",
  component: Workspace,
  meta: { title: "Workspace - manager", requiresAuth: true },
  children: [
    {
      path: "folder/:id",
      component: Folder,
  ...
  routes: [
    {
      ...
      name: "home",
      component: Home,
      meta: { title: "manager", redirect: true }
    },
    {
      path: "/signup/:id",
      name: "signup",
      component: Signup,
      meta: { title: "Signup - manager" }
    },
    login,
    {
      path: "/decline/:id",
    ...
    workspace,
    {
      ...
      name: "account",
      component: Account,
      meta: { title: "Accounts - manager", requiresAuth: true }
    },
    {
      path: "/settings",
      name: "settings",
      component: Settings,
      meta: { title: "Settings - manager", requiresAuth: true }
    }
  ]
});
